      ...
      <div class="cae-fl j-cae-flr">
        <div class="cae-mnc j-cae-mnc j-cae-mnc-s">
          <div class="cae-co j-cae-co" caeActive="false">
            <img class="cae-img cae-img-tp cae-img-wi cae-img-he j-cae-img j-cae-img-tp" src="./image/ion.png" />
            <img class="cae-img cae-img-bm cae-img-wi cae-img-he j-cae-img j-cae-img-bm" src="./image/ion.png" />
...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    mounted: function () {
      ...
      CanvasAvatar.getSizeMax(5000);
      CanvasAvatar.setRemovalImgSize(210, 280);
